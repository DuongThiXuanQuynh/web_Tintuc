        ...
        <div class="col-sm-3 col-md-2 sidebar">
         <ul class="nav nav-sidebar">
          ...
          <div class="table-responsive">
            ...
            <form method="POST" id="formSua" data-id="' . $row_TL["idTL"] . '" class="form-cate">
                <div class="form-group">
                    <label>Tên thể loại</label>
                    <input type="text" class="form-control Ten" name="TenTL" id="TenTL" value="<?php echo $row_TL["TenTL"]?>">
                </div>
                <div class="form-group">
                    <label>Thứ tự </label>
                    <input type="text" class="form-control TT" name="ThuTu" id="ThuTu" value="<?php echo $row_TL["ThuTu"]?>">
                </div>
                <div class="form-group">
                    <label>Ẩn hiện</label>
                    <div class="radio">
                        <label>
                            <input type="radio" name="AnHien" value="1" id="AnHien_1" <?php if($row_TL["AnHien"]==1) echo "checked='checked'"?>/>
              Hiện</label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="AnHien" value="0" id="AnHien_0" <?php if($row_TL["AnHien"]==0) echo "checked='checked'"?>/>
              Ẩn</label>
                    </div>
                </div>
                                <div class="form-group">
