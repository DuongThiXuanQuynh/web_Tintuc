          ...
          <div class="table-responsive">
            ...
            <form method="POST" id="formThem" data-id="#" class="form-cate">
              ...
              1-Top phải</label>
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="ViTri" value="0" id="vitri_1" />
              2-Cuối trang</label>
                    </div>
                </div>
                <div class="form-group">
                    <label>Mô tả</label>
                    <input type="text" class="form-control title" name="MoTa" id="MoTa">
                </div>
                <div class="form-group">
                    <label>URL </label>
                    <input type="text" class="form-control slug" name="Url" id="Url">
                </div>
                <div class="form-group">
                    <label>URL hình</label>
                    <input type="text" class="form-control slug" name="urlHinh" id="urlHinh">
                </div>
